...
datasets <- list(
  ...
  Tiassale = list(
    ...
    pos_ctrl = c(-4.263400815, -1.942727706, -0.670711124, -0.309801658)
  ),
  ...
  Tiefora = list(
    ...
    pos_ctrl = c(0.642171622, -0.112125204, -0.907194831, -0.093306988)
  ),
  ...
  "N´Gousso" = list(
    ...
    pos_ctrl = c(0.485793009, 0.074515218, -0.351781145, -0.823133221)
  )
